...
Next, run `pip3 install algorithmia` to install the Algorithmia Python client and run `python3 data.py <algorithmia user name> <algorithmia api key>` to upload the files to the data store.
...
3. Commit all files in your repo and `git push` (this takes a while).
