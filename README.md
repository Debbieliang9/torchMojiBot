...
1. Create a [Slack workspace](https://slack.com/create), create a [Slack app](https://api.slack.com/apps/) that links to the workspace and grant OAuth permissions as described [here](https://www.dropbox.com/scl/fi/4qiwlzk4svme87vpazdp1/Build-a-Slackbot.paper?dl=0&rlkey=c56v0mst1s7ivhokfnfqignjx) (step 2).
...
5. Paste the REST endpoint URL to the Slack bot's event subscription page and configure event subscription as described [here](https://www.dropbox.com/scl/fi/4qiwlzk4svme87vpazdp1/Build-a-Slackbot.paper?dl=0&rlkey=c56v0mst1s7ivhokfnfqignjx) (step 3).
