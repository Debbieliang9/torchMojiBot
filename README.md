...
1. Create a test [workspace](https://slack.com/create), create a [Slack app](https://api.slack.com/apps/) that links to the workspace and grant permissions/subscriptions as outlined [here](https://www.dropbox.com/scl/fi/4qiwlzk4svme87vpazdp1/Build-a-Slackbot.paper?dl=0&rlkey=c56v0mst1s7ivhokfnfqignjx).
